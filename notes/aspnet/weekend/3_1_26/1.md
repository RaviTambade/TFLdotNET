Below is a **ready-to-deliver classroom lecture script**, written exactly the way a **mentor would speak**, with **pauses, questions, examples, and storytelling**.
You can **read it aloud**, adapt it, or convert it directly into slides later.

---

# 🎓 Classroom Lecture Script

## *Microservices + API Gateway – A Mentor’s Story*
...
Below is a **complete, classroom-ready Student Lab Assignment**, designed exactly for **Finishing School / PG-DAC / Final-year engineering students**, aligned with the **Microservices + API Gateway** architecture you taught.

You can **hand this as a PDF / LMS post / lab sheet** without modification.
...
## 🎓 Mentor Closing Note (Read to Students)
...
Below is the **complete Solution Reference (Answer Key)** for the **Student Lab Assignment**.
This is written **for mentors**, not students — you can use it to **validate submissions, debug issues, or demonstrate the correct approach**.
