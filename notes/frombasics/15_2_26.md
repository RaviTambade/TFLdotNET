...
Target: **.NET 8 – Simple Synchronous Style**



# 🌱 Create GreenhouseApi (Synchronous Version) Using .NET CLI
...
# ✅ Step 2: (Optional) Create Solution
...
# ✅ Step 8: Repository Layer (Synchronous)
...
# ✅ Step 9: Service Layer (Synchronous)
